...
describe("BreedCard", () => {
  ...
  describe("Rendering", () => {
    it("should render breed name", () => {
      ...
      (useBreedVariantNames as unknown as Mock).mockReturnValue(["Golden Retriever"]);
    ...
    it("should render variant names when breed has variants", () => {
      ...
      (useBreedVariantNames as unknown as Mock).mockReturnValue(["Small Poodle", "Large Poodle"]);

      renderWithMantine(<BreedCard id={1} name="Poodle" onClick={mockOnClick} />);
    ...
    it("should handle breed names with ß character", () => {
      ...
      renderWithMantine(<BreedCard id={1} name="Großpudel" onClick={mockOnClick} />);
  ...
  describe("Interaction", () => {
    ...
    it("should track card click with analytics", () => {
      ...
      expect(mockTrack).toHaveBeenCalledWith("Breed Card Clicked", expect.objectContaining({
        breedId: "1",
  ...
  describe("Accessibility", () => {
    ...
    it("should render text with proper truncation classes", () => {
      ...
      const cardNameText = nameTexts.find((el) => el.closest(".breed-card-name-text"));
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle numeric breed IDs correctly", () => {
      ...
      renderWithMantine(<BreedCard id={999} name="Golden Retriever" onClick={mockOnClick} />);
